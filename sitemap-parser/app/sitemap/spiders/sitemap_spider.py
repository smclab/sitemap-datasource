...
from sitemap.items import GenericWebItem, Payload
from .util.generic.utility import get_favicon, get_title, get_content
...
class CustomSitemapSpider(SitemapSpider):
    ...
    def parse(self, response):
        ...
        if hasattr(response, "text"):
            ...
            parse_document_by_url(response.url, self)
