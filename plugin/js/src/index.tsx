...
export const plugin: Plugin<WebResultItem> = {
  pluginId: "sitemap-datasource",
  displayName: "Sitemap DataSource",
  pluginServices: [
    {
      type: "DATASOURCE",
      displayName: "Web Sitemap DataSource",
      driverServiceName: "io.openk9.plugins.sitemap.driver.SitemapWebPluginDriver",
      initialSettings: `
        {
            "datasourceId": 1,
            "timestamp": 0,
    ...
    {
      type: "ENRICH",
      displayName: "Sitemap Async NER",
      serviceName:
        "io.openk9.plugins.sitemap.enrichprocessor.AsyncWebNerEnrichProcessor",
      initialSettings: `
      {
    ...
    },
    {
      ...
      serviceName:
        "io.openk9.plugins.sitemap.enrichprocessor.AsyncTikaEnrichProcessor",
      initialSettings: `
      {
          "type_mapping": {
              "application/pdf": "pdf",
